...
public class VideoService {
    ...
    /**
     * Layer 1 & 2: Kiá»ƒm tra enrollment vÃ  táº¡o Signed URL cho file MP4 Ä‘Æ¡n láº».
     */
    ...
    /**
     * Layer 3: HLS Streaming vá»›i Proxy Playlist.
     * Ká»¹ thuáº­t nÃ y kÃ½ tÃªn cho tá»«ng máº£nh (.ts) trong playlist.
     */
    public String getProxyHlsPlaylist(Long lessonId, Long userId) {
        ...
        String videoPath = lesson.getVideoUrl(); // Giáº£ Ä‘á»‹nh lÃ  path/to/playlist.m3u8
        ...
        try (InputStream stream = minioClient.getObject(
            ...
            return reader.lines().map(line -> {
                if (line.endsWith(".ts")) {
                    // KÃ½ tÃªn cho tá»«ng segment
                    return getSignedUrlForObject(baseDir + line, 30); // Segment háº¿t háº¡n sau 30 phÃºt
                }
                if (line.startsWith("URI=\"")) {
                    // Náº¿u cÃ³ key mÃ£ hÃ³a (DRM Layer 4 - AES-128)
