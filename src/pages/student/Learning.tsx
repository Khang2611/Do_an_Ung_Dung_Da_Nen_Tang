...
function hasRealUploadedVideo(lesson: Lesson) {
  return Boolean(lesson.videoUrl && lesson.videoUrl !== "test/playlist.m3u8");
}
        ...
        {hasRealUploadedVideo(lesson) ? (
          ...
          <div className="grid aspect-video place-items-center rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
            <div>
              ...
              <h3 className="mt-4 text-lg font-bold text-slate-950">Bài học chưa có video upload thật</h3>
              <p className="mt-2 max-w-md text-sm leading-6 text-slate-500">
                Giảng viên cần upload video MP4 cho bài học này. Hệ thống sẽ lưu video lên MinIO trước khi học viên xem.
              </p>
            </div>
          </div>
        )}
