    ...
    <form onSubmit={handleSubmit(submit)} className="max-w-6xl space-y-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-[260px_1fr]">
          ...
          />
          <div className="rounded-2xl bg-slate-50 p-4 text-sm text-slate-600">Chọn bản nháp khi đang biên soạn, chờ duyệt khi gửi quản trị viên, hoặc đã xuất bản cho khóa học demo.</div>
        </div>
      </section>
