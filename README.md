...
## Cải thiện UI sau góp ý giảng viên

- Đã cải thiện giao diện bằng Tailwind CSS, không thêm Bootstrap.
- Đã bổ sung React Hook Form cho Login, Register và CourseForm.
- Đã Việt hóa trạng thái và vai trò hiển thị trên giao diện.
- Vẫn giữ mock mode, mock data và toàn bộ route hiện có.
- Backend connection sẽ thực hiện ở bước tiếp theo.
